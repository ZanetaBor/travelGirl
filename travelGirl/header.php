...
<body <?php body_class()?>>
   ...
   <header>
      ...
      <!-- Start Logo  -->
      <div class="logo-link">
         <a href="<?php echo esc_url(home_url('/'));?>"><img src="http://localhost:8888/ministronka/trap/wp-content/uploads/2021/10/mini_app_square_white.png" alt="Ministronka" alt="Ministronka"></a>
      </div>
      <!-- End Logo  -->
      ...
      <div class="navigation-bar">
         <nav><?php wp_nav_menu(array('name' => 'minor menu'
            )); ?>
            </nav>
      </div>
      <!-- End Navigation -->
